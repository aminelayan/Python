...
def checkout():
    ...
    return render_template("checkout.html", firstname_template=first_name, lastname_template=last_name, studentid=student_id, straw_amt=strawberry_amt, raspb_amt=raspberry_amt, apple_amt=apple_amt )
